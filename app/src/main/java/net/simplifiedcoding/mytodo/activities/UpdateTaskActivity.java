...
public class UpdateTaskActivity extends AppCompatActivity {
    ...
    private EditText editTextTask, editTextDesc, editTextFinishBy,editTextComment;
    ...
    private void loadTask(Task task) {
        ...
        editTextComment.setText(task.getComment());
    ...
    private void updateTask(final Task task) {
        ...
        final String sComment= editTextComment.getText().toString().trim();
        ...
        if (sComment.isEmpty()) {
            editTextComment.setError("Finish by required");
