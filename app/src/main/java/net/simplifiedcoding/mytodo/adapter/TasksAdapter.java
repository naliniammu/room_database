package net.simplifiedcoding.mytodo.adapter;
...
import net.simplifiedcoding.mytodo.activities.UpdateTaskActivity;
...
public class TasksAdapter extends RecyclerView.Adapter<TasksAdapter.TasksViewHolder> {
    ...
    class TasksViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        TextView textViewStatus, textViewTask, textViewDesc, textViewFinishBy,textViewComment;
